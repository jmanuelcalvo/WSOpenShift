...
## Por Navegador
```
https://loadbalancer.b91b.example.opentlc.com/
```

## Acceso por SSH a la maquina Bastion
```
ssh user0X@bastion.b91b.example.opentlc.com
oc login https://loadbalancer.b91b.internal:443 -u user0X -p redhat01
```
