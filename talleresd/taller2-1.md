...
# Uso basico de la herramienta GIT


# Conectarse por SSH / Putty a la maquina

### bastion.qb9sl.sandbox322.opentlc.com con el usuario user0X
...
* Desde la Consola Web de github cree un nuevo repositorio ingresando a la pestaña repositories
...
Luego de crear el repositorio por la consola Web descargar una copia local del repositorio en su terminal local, vaya a la aplicacion web, ingrese a su repositorio y copie el URL.
...
```
[user0X@bastion ~]$ git clone https://github.com/<usuario>/proyecto1.git
...
Para realizar el push en github, ahora es requerido generar un Token, para ello en el icono del usuario -> Settings -> menu izquierdo -> Developer settings -> Personal access tokens -> Tokens (classic) -> Generateo new token
